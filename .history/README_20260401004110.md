...
<img align="right" src="https://i.imgflip.com/65efzo.gif" width="300" style="border-radius: 10px; margin-left: 18px;" />
...
>Também possuo experiência em testes e validação de funcionalidades, realizando testes manuais e teste de API para garantir qualidade das aplicações. Além disso, tenho base em análise de dados utilizando SQL, Python (Pandas) e Power BI para tratamento de dados e construção de dashboards.</span>
</p>
